...
**Try it here**: [https://frame-ai.bejayketanguin.com/](https://frame-ai.bejayketanguin.com/){:target="_blank" rel="noopener noreferrer"}
**GitHub**: [https://github.com/BKG123/frame-ai](https://github.com/BKG123/frame-ai){:target="_blank" rel="noopener noreferrer"}
...
**Want to see it in action?** Check out the [video demo on the project page](/projects/frame-ai/).
...
2. **Enhancement**: AI-powered edits based on the analysis
...
There were multiple iterations in a loop of claude doing something in FE -> Me not liking it -> putting ss in the input and asking it to rebuild. Also used Cursor's in built browser tool to let it gather info of current FE design and make some tweaks.
...
- Have some ideas about image evals from [Storia-AI](https://github.com/Storia-AI/image-eval){:target="_blank" rel="noopener noreferrer"}
